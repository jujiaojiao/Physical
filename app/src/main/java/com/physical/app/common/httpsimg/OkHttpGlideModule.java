package com.physical.app.common.httpsimg;
...
public class OkHttpGlideModule implements GlideModule {
    ...
    public void registerComponents(Context context, Glide glide) {
        glide.register(GlideUrl.class, InputStream.class, new OkHttpUrlLoader.Factory(RequestClient.getInstance().getOkHttpClient()));
    }
}
